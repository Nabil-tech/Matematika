...
def main():
	...
	f'{cyan} {red}               ■=========■\n',
	f'{cyan} {yellow}            ■===============■\n',
	f'{cyan} {yellow}   ■-------●|{cyan}{yellow}A{red}u{green}t{white}h{blue}o{purple}r{yellow}: {green}NblCode{yellow}|●--------■\n',
	f'{cyan} {green}   ■==================================■\n',
	f'{cyan} {green}   |    {red}.{red}^-----^{red}---.---.-.--------.{green}   |\n',
	f'{cyan} {green}   | {white}  {cyan}{red}|   __|  _  |  _  |        |{green}   |\n',
	f'{cyan} {green}   |  {white}{cyan}{red} |--   |   __|___._|__|__|__|{green}   |\n',
	f'{cyan} {green}   |   {red}`-----|__| {purple} -=Tool Spam=-{green}      |\n',
	f'{cyan} {green}   ■==================================■\n',
	f'{purple}-> {yellow}Contoh{yellow}:{green} 082321404666',)
	x = input(f'{purple} ->{yellow} Masukan Nomor Target{yellow}:{green}')
	z = input(f'{purple} ->{yellow} Berapa Suntikan{yellow}:{green} ')
	print()
...
def starting(shipping):
	if len(load) == int(shipping):
		exit(f'{white} --{purple} <{white} Status: {green} -DONE- {purple}> ')
	else:
		pass
